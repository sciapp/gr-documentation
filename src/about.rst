...
at `Forschungszentrum Jülich <https://www.fz-juelich.de>`_.
...
.. toctree::
   ...
   Fonts <fonts.rst>
   Resampling Methods <resampling_methods.rst>
...
* A complete list of talks, workshops and other publications can be found :doc:`here <references>`.

.. toctree::
   :hidden:

   List of References <references.rst>
